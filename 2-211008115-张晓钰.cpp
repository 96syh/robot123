...
int main() {
	...
	double k = 2;
	hanshu(&x, &y, k, a, b);
	cout << "zhangxiaoyu" << x << endl;
	cout << "zhangxiaoyu" << y << endl;
	hanshu(&x1, &y1, k, a, b);
	cout << "zhangxiaoyu" << x1 << endl;
	cout << "zhangxiaoyu" << y1 << endl;
	hanshu(&x2, &y2, k, a, b);
	cout << "zhangxiaoyu" << x2 << endl;
	cout << "zhangxiaoyu" << y2 << endl;
}
